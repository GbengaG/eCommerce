...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    // create new text style with some properties changed from the default (i.e default + custom)
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.normal,color: TColors.dark,),
